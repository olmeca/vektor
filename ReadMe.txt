...
with all BSN values in the 02 lines by the value "999999999":
	vektor copy original.asc -copy.asc -e:0403=999999999
...
All command line options have a short version (e.g. -e:"0210=Johnson")
...
empty you just add another element specification:
	vektor modify copy.asc  -e:"0203=999999999,0210" original.asc
...
To anonymize the last name and birth date fields of the 02 record:
	vektor modify original.asc copy.asc -e:"0210=@name,0207=@date:19000101-20100101"

Example 4:
To clear the value of the BSN and 'last name' field of the 02 record:
	vektor modify original.asc copy.asc -e:0203,0210
