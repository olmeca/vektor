...
Short version:
To anonymize a declaration file:
	vektor modify original.asc -o:copy.asc -l:02 -e:"03=999999999,10=@name"
This will create a copy 'copy.asc' based on 'original.asc',
where all '02' line will have '999999999' as value for the 
03 element (BSN) and a random name for element '10' (last name)
...
bulk modifying the value of any line element. You provide it a line 
element ID(e.g. "0203" for BSN) and a value (e.g. "999999999") 
...
Though Vektor has no knowledge of BSN's or dates, it does know about
value types specified in the Vektis EI standards. In short, it
knows to check for numerical values where required and it will pad
values to preserve field length.
...
with all BSN values in the 02 lines by the value "999999999":
	vektor modify original.asc -o:copy.asc -l:02 -e:03=999999999
...
Note that the command line options are specified with a colon (:)
...
Example 3:
To anonymize the BSN and last name fields of the 02 record:
	vektor modify original.asc -o:copy.asc -l:02 -e:"03=999999999,10=@name"
...
To display values of specific elements of specific line types:
	vektor print original.asc -o:copy.asc -l:02 -e:03,10
