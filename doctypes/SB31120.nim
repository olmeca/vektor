...
proc createLineTypeSB3112003(): LineType =
    let leTypes = @[
        ...
        newLeType("0329", "DAT320", "N", 300, 8, nil, nil, nil, false, "MACHTIGINGSDATUM AUTOMATISCHE INCASSO"),
        newLeType("0330", "COD655", "AN", 308, 1, nil, nil, nil, false, "FACTURATIEVORM"),
        newLeType("0380", "TEC007", "AN", 309, 1, nil, nil, nil, false, "RESERVE")
    ]
    result = LineType(
       name: "DebiteurRecord",
       length: 310,
