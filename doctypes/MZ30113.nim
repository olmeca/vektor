...
proc createLineTypeMZ3011304(): LineType =
    let leTypes = @[
        ...
        newLeType("0426", "BED153", "N" , 135,   8, ""    , ""    , ""    , true  , UnsignedAmountValueType , "BEREKEND BEDRAG (INCL. BTW)"),
        newLeType("0427", "COD668", "AN", 143,   1, ""    , ""    , ""    , true  , StringValueType         , "INDICATIE DEBET/CREDIT (01)"),
        ...
        newLeType("0430", "BED161", "N" , 156,   8, ""    , ""    , ""    , true  , UnsignedAmountValueType , "DECLARATIEBEDRAG (INCL. BTW)"),
        newLeType("0431", "COD665", "AN", 164,   1, ""    , ""    , ""    , true  , StringValueType         , "INDICATIE DEBET/CREDIT (02)"),
...
proc createLineTypeMZ3011399(): LineType =
    let leTypes = @[
        ...
        newLeType("9907", "BED025", "N" ,  34,  11, "0426", ""    , ""    , false , UnsignedAmountValueType , "TOTAAL DECLARATIEBEDRAG"),
        newLeType("9908", "COD043", "AN",  45,   1, ""    , ""    , ""    , true  , StringValueType         , "INDICATIE DEBET/CREDIT"),
